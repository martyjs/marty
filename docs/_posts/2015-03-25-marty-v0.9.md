...
Thanks to [@jdalton](https://github.com/jdalton) we've moved from underscore.js to lodash internally (This won't affect you if you're using underscore in you're website). This has resulted in a 6KB drop in our gzipped file size.
